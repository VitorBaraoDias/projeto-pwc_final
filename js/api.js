...
function getCardDog(imagemUrl,nome,id,descricao) {
  ...
  divAnimal.innerHTML = `
    <div class="card">
        ...
        <svg class="like ${testFavDog(id)}" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-heart"  onclick="setFavorito(${id})" data-index="${id}">
